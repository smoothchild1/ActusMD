...
- [ ] **Phase 2 (Agent 2):** WebSockets & AI Integration (Socket.io rooms, Azure AI Speech routing, Azure OpenAI multimodal handling).
- [ ] **Phase 3 (Agent 3):** Frontend Scaffold & Sync (Expo/React Native setup, NativeWind layout, Socket.io client, AudioDictation, WebUpload).
